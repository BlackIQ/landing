...
const features = [
  {
    ...
    description: "Minimal resource usage designed for production environments.",
  },
  {
    title: "Real-Time Monitoring",
    description: "Observe your infrastructure as metrics are collected.",
  },
  {
    title: "Historical Metrics",
    description: "Analyze trends over time and compare system behavior.",
  },
  {
    title: "Service Monitoring",
    description: "Monitor system services and availability from a single view.",
  },
  {
    title: "Container Support",
    description: "Collect metrics from containerized workloads and hosts.",
  },
  {
    title: "Secure Communication",
    description: "Authenticated communication between agents and dashboard.",
  },
  {
    title: "Open Source",
  ...
  {
    title: "REST API",
    description: "Integrate Metrics into your own tooling and workflows.",
  },
];
...
const relatedProducts = [
  {
    ...
    description: "Coming soon for website and API monitoring.",
  },
  {
    name: "Analytics",
    href: "/products/analytics",
    description: "Future analytics product for privacy-first insights.",
  },
];
...
export const metadata: Metadata = {
  ...
  description:
    "OpenHubble Metrics provides infrastructure observability for servers, services, containers, and system health.",
};
    ...
    <ProductPageShell accent={accent}>
        ...
        <div className="grid gap-8 rounded-[32px] border border-slate-200 bg-white p-8 shadow-[0_16px_40px_rgba(15,23,42,0.04)] lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:p-10">
          <div>
            ...
            <p className="mb-4 text-xl font-medium" style={{ color: accent }}>
              Collect real-time infrastructure telemetry from your servers with
              lightweight agents.
            </p>
            <p className="max-w-2xl text-lg leading-8 text-slate-600">
              Monitor CPU, memory, disks, services, containers, and system
              health from a modern dashboard.
            </p>
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-6 sm:p-8">
            ...
            <div className="mt-5 space-y-5">
              {[
                { title: "CPU", detail: "Processor load and saturation." },
                {
                  title: "Memory",
                  detail: "Usage, pressure, and available capacity.",
                },
                { title: "Disk", detail: "Space, I/O, and throughput." },
                {
                  title: "Network",
                  detail: "Traffic, errors, and packet loss.",
                },
                {
                  title: "Services",
                  detail: "Availability and health over time.",
                },
                {
                  title: "Containers",
                  detail: "Resource usage across workloads.",
                },
              ].map((item) => (
                <div
                  key={item.title}
      ...
      >
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.04)] sm:p-8">
          ...
          <p className="mt-5 text-base leading-8 text-slate-600">
            Install the OpenHubble Metrics Agent in seconds. Once connected,
            your infrastructure immediately begins reporting metrics to your
            dashboard.
          </p>
        </div>
      </section>
        ...
        <div className="flex flex-col gap-6 rounded-3xl border border-slate-200 bg-white p-8 shadow-[0_16px_40px_rgba(15,23,42,0.04)] md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <p className="max-w-2xl text-base leading-8 text-slate-600">
              Manage servers, groups, tags, services, infrastructure metrics,
              and system health from a clean and responsive interface.
            </p>
          </div>
          <a
            href="https://metrics.openhubble.com"
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-20">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8">
          <p className="text-base leading-8 text-slate-600">
            The OpenHubble Metrics Agent is designed to stay small and
            predictable. It gathers system and service data with low overhead
            and sends it to the platform using authenticated connections.
          </p>
        </div>
      </section>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-8 sm:p-10">
          <div className="max-w-3xl">
            ...
            <h3 className="mb-3 text-3xl font-semibold text-slate-900">
              The dashboard and the agent are open source.
            </h3>
            <p className="text-base leading-8 text-slate-600">
              Contributions are welcome. If you are working on infrastructure
              monitoring, system administration, or dashboard tooling, the
              project is open to discussion and collaboration.
            </p>
          </div>
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm font-medium text-slate-700 transition hover:bg-white"
            >
              Metrics Agent
            </a>
            <a
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-20">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <a
            href="https://metrics.openhubble.com/docs"
            target="_blank"
            rel="noreferrer"
            className="rounded-3xl border border-slate-200 bg-white p-6 transition hover:bg-slate-50"
          >
            <h3 className="text-lg font-semibold text-slate-900">
              Documentation
            </h3>
            <p className="mt-2 text-sm leading-7 text-slate-600">
              Guides for installing, configuring, and operating the agent and
              dashboard.
            </p>
          </a>
          <a
            href="https://api.metrics.openhubble.com/redoc"
            target="_blank"
            rel="noreferrer"
            className="rounded-3xl border border-slate-200 bg-white p-6 transition hover:bg-slate-50"
          >
            ...
            <p className="mt-2 text-sm leading-7 text-slate-600">
              Details for integrating Metrics into your own tooling and
              services.
            </p>
          </a>
        </div>
