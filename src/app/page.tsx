...
const products = [
  {
    name: "Metrics",
    description: "Collect infrastructure, container, and service telemetry with dependable dashboards.",
    accent: "#3B82F6",
  },
  {
    name: "Uptime",
    description: "Monitor services, public status, and incidents with confidence and clarity.",
    accent: "#10B981",
  },
  {
    name: "Analytics",
    description: "Capture product and web insights with privacy-friendly SDKs and real-time events.",
    accent: "#8B5CF6",
  },
];
...
const features = [
  {
    title: "Open Source",
    description: "Built for the community and shaped by contributors who believe in transparency.",
  },
  {
    title: "Developer Experience",
    description: "Thoughtful workflows, straightforward integrations, and clean interfaces for fast delivery.",
  },
  {
    title: "Self Hosted",
    description: "Deploy with control, keep your data close, and align the platform with your operations.",
  },
  {
    title: "Reliable",
    description: "Designed for steady growth with a platform foundation that scales alongside your team.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900">
      <header className="sticky top-0 z-10 border-b border-slate-200/80 bg-[#f8fafc]/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-4 sm:flex-row sm:items-center sm:justify-between lg:px-8">
          ...
          <nav className="flex flex-wrap items-center gap-4 text-sm text-slate-700">
            ...
            <Link href="#roadmap" className="transition hover:text-slate-950">
              Roadmap
            </Link>
      ...
      <main>
        <section className="mx-auto grid max-w-6xl gap-8 px-6 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:px-8 lg:py-24">
          <div>
            <div className="mb-6 flex flex-wrap gap-2">
              ...
              <span className="rounded-full border border-slate-300 px-3 py-1 text-sm text-slate-700">Developer Friendly</span>
            </div>
            ...
            <p className="max-w-2xl text-lg leading-8 text-slate-600">
              OpenHubble is an open-source observability platform for teams building modern systems. It brings metrics, uptime, and analytics together into one thoughtful ecosystem for exploring data and acting with clarity.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link href="#products" className="rounded-full bg-[#3B82F6] px-6 py-3 text-center font-medium text-white transition hover:bg-[#2563EB]">
                Get Started
              </Link>
              <a href="https://github.com/OpenHubble" target="_blank" rel="noreferrer" className="rounded-full border border-slate-300 px-6 py-3 text-center font-medium text-slate-700 transition hover:bg-white">
                GitHub
              </a>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.04)] sm:p-8">
            ...
            <div className="mt-5 space-y-5">
              {[
                { title: "Metrics", detail: "Infrastructure health, collectors, and service visibility." },
                { title: "Uptime", detail: "Status pages, alerts, and incident moments in one place." },
                { title: "Analytics", detail: "Privacy-friendly insight collection for real products." },
              ].map((item) => (
        ...
        <section id="products" className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-20">
          <SectionHeading
            eyebrow="Products"
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {products.map((product) => (
              <article key={product.name} className="rounded-3xl border border-slate-200 bg-white p-6">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl" style={{ backgroundColor: `${product.accent}14`, color: product.accent }}>
                  <span className="text-lg font-semibold">{product.name[0]}</span>
                </div>
                <h3 className="mb-2 text-xl font-semibold text-slate-900">{product.name}</h3>
                <p className="leading-8 text-slate-600">{product.description}</p>
                <a href="#" className="mt-6 inline-flex items-center gap-2 font-medium" style={{ color: product.accent }}>
                  Learn More
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-8 sm:p-10">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <h3 className="mb-3 text-3xl font-semibold text-slate-900">OpenHubble believes in community-driven progress.</h3>
                <p className="max-w-2xl text-lg leading-8 text-slate-600">
                  The ecosystem is designed to invite collaboration, sharing, and contribution from developers everywhere.
                </p>
              </div>
              <a href="https://github.com/OpenHubble" target="_blank" rel="noreferrer" className="rounded-full bg-slate-950 px-6 py-3 text-center font-medium text-white transition hover:bg-slate-800">
                GitHub
              </a>
            </div>
          </div>
        ...
        <section id="roadmap" className="mx-auto max-w-6xl px-6 py-16 lg:px-8 lg:py-20">
          <SectionHeading
            eyebrow="Roadmap"
