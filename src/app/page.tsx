...
function SectionHeading({
  ...
  return (
    <div className="mb-8 max-w-2xl">
      <p className="mb-3 text-sm font-semibold uppercase tracking-[0.24em] text-slate-300">
        {eyebrow}
      </p>
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <header className="sticky top-0 z-10 border-b border-slate-800/60 bg-slate-950/95 backdrop-blur">
        <div className="mx-auto flex max-w-6xl flex-col gap-3 px-6 py-4 sm:flex-row sm:items-center sm:justify-between lg:px-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <span className="text-lg font-semibold text-white">OpenHubble</span>
          </Link>
          <nav className="flex flex-wrap items-center gap-4 text-sm text-slate-300">
            <details className="group relative">
              <summary className="flex cursor-pointer list-none items-center gap-2 rounded-full border border-slate-700 px-4 py-2 transition hover:border-slate-500 hover:bg-slate-900">
                Products
                <span className="text-xs text-slate-400">▾</span>
              </summary>
              <div className="absolute right-0 top-full mt-2 min-w-40 rounded-2xl border border-slate-800 bg-slate-950 p-2 shadow-[0_10px_30px_rgba(0,0,0,0.4)]">
                <Link
                  href="/products/metrics"
                  className="block rounded-xl px-3 py-2 text-slate-300 transition hover:bg-slate-900 hover:text-white"
                >
                  Metrics
                </Link>
                <Link
            ...
            <Link
              href="#contact"
              className="rounded-full border border-slate-950 bg-slate-950 px-4 py-2 text-white transition hover:bg-slate-900"
            >
              Contact
            </Link>
          </nav>
        ...
        <section className="mx-auto grid max-w-6xl gap-8 px-6 py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:px-8 lg:py-24">
          <div>
            <div className="mb-6 flex flex-wrap gap-2">
              <span className="rounded-full border border-slate-600 bg-slate-950 px-3 py-1 text-sm text-slate-300">
                Open Source
              </span>
              <span className="rounded-full border border-slate-600 bg-slate-950 px-3 py-1 text-sm text-slate-300">
                Self Hosted
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="#products"
                className="rounded-full bg-slate-950 px-6 py-3 text-center font-medium text-white transition hover:bg-slate-800"
              >
                Get Started
              </Link>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-full border border-slate-950 bg-slate-950 px-6 py-3 text-center font-medium text-white transition hover:bg-slate-800"
              >
                GitHub
              </a>
            </div>
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-950 p-6 shadow-[0_16px_40px_rgba(0,0,0,0.4)] sm:p-8">
      ...
      <footer id="contact" className="border-t border-slate-800 bg-slate-950">
        <div className="mx-auto flex max-w-6xl flex-col gap-8 px-6 py-10 lg:flex-row lg:justify-between lg:px-8">
          <div>
            <h4 className="text-lg font-semibold text-white">OpenHubble</h4>
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            ...
            <div>
              <h5 className="mb-2 font-semibold text-white">Resources</h5>
            ...
            <div>
              <h5 className="mb-2 font-semibold text-white">Contact</h5>
              <a
